	...
	<div class="navbar-collapse collapse">
		<ul class="navbar-nav navbar-align">
			<li>
				...
				</form> --> <select id="plant"
				class="form-control browser-default custom-select">
				<option value="male">Global</option>
					<option value="male">Plant1</option>
					<option value="female">Plant2</option>
					<option value="unspesified">Plant3</option>
			</select>
			</li>
			...
			<li class="nav-item dropdown"><a
				...
				href="#" data-bs-toggle="dropdown"> <!--  <img
					...
					alt="Charles Hall" />  --> <span class="text-dark">Hi <%=username%></span>
			</a>
